...
export const CHURCH_STATUS_SEED: ChurchStatus = {
  ...
  residentialBreakdown: [
    ...
    { id: "area-seoul-gangnam", area: "강남구", count: 0 },
    { id: "area-seoul-gangdong", area: "강동구", count: 0 },
    { id: "area-seoul-gangbuk", area: "강북구", count: 0 },
    { id: "area-seoul-gangseo", area: "강서구", count: 0 },
    { id: "area-seoul-gwangjin", area: "광진구", count: 0 },
    { id: "area-seoul-guro", area: "구로구", count: 0 },
    { id: "area-seoul-nowon", area: "노원구", count: 0 },
    { id: "area-seoul-dobong", area: "도봉구", count: 0 },
    { id: "area-seoul-dongdaemun", area: "동대문구", count: 0 },
    { id: "area-seoul-mapo", area: "마포구", count: 0 },
    { id: "area-seoul-seodaemun", area: "서대문구", count: 0 },
    { id: "area-seoul-seocho", area: "서초구", count: 0 },
    { id: "area-seoul-seongdong", area: "성동구", count: 0 },
    { id: "area-seoul-seongbuk", area: "성북구", count: 0 },
    { id: "area-seoul-songpa", area: "송파구", count: 0 },
    { id: "area-seoul-yangcheon", area: "양천구", count: 0 },
    { id: "area-seoul-yeongdeungpo", area: "영등포구", count: 0 },
    { id: "area-seoul-yongsan", area: "용산구", count: 0 },
    { id: "area-seoul-eunpyeong", area: "은평구", count: 0 },
    { id: "area-seoul-jongno", area: "종로구", count: 0 },
    { id: "area-seoul-jung", area: "중구", count: 0 },
    { id: "area-seoul-jungnang", area: "중랑구", count: 0 },
    { id: "area-other-seoul", area: "서울 기타(미분류)", count: 33 },
    { id: "area-gg-gwacheon", area: "과천시", count: 0 },
    { id: "area-gg-gwangmyeong", area: "광명시", count: 0 },
    { id: "area-gg-gunpo", area: "군포시", count: 0 },
    { id: "area-gg-goyang", area: "고양시", count: 0 },
    { id: "area-gg-guri", area: "구리시", count: 0 },
    { id: "area-gg-gimpo", area: "김포시", count: 0 },
    { id: "area-gg-namyangju", area: "남양주시", count: 0 },
    { id: "area-gg-bucheon", area: "부천시", count: 0 },
    { id: "area-gg-seongnam", area: "성남시", count: 0 },
    { id: "area-gg-suwon", area: "수원시", count: 0 },
    { id: "area-gg-siheung", area: "시흥시", count: 0 },
    { id: "area-gg-ansan", area: "안산시", count: 0 },
    { id: "area-gg-anyang", area: "안양시", count: 0 },
    { id: "area-gg-yangju", area: "양주시", count: 0 },
    { id: "area-gg-yongin", area: "용인시", count: 0 },
    { id: "area-gg-uiwang", area: "의왕시", count: 0 },
    { id: "area-gg-uijeongbu", area: "의정부시", count: 0 },
    { id: "area-gg-paju", area: "파주시", count: 0 },
    { id: "area-gg-hanam", area: "하남시", count: 0 },
    { id: "area-gg-hwaseong", area: "화성시", count: 0 },
    { id: "area-gyeonggi", area: "경기 기타(미분류)", count: 33 },
  ...
  demographicsNote:
    "관악구 거주 46명(29%) · 동작구 8명 · 금천구 1명. 서울 타 구 33명(21%)과 경기권 33명(21%)은 현재 '미분류'로 집계되어 있음 — 교적부 주소 정밀 분석 후 구·시별로 세분화 예정. 주소 미입력 35명 보완 필요. 나이 '미입력' 60명은 교적부 생년월일 보완 필요. 영유아부 department 미지정으로 0으로 표시됨(실제 자녀 존재 시 유초등부 14에 포함 가능).",
